(() => {
  const validVersions = ['cinematic', 'parchment', 'ember', 'garden', 'midnight', 'mono', 'bears', 'purple', 'chicago', 'milwaukee', 'ocean', 'harvest', 'desert', 'rose', 'electric'];
  ...
  const theme = queryVersion
    ? (version === 'parchment' || version === 'milwaukee' || version === 'desert' || version === 'rose' ? 'light' : 'dark')
